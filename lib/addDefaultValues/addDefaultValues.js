...
/** 
 * @type {{ [parentSchemaUri: string]: string[] }} 
 */
const coveredPropertiesMap = {};

/** 
 * @type {{ [parentSchemaUri: string]: number[] }} 
 */
const coveredItemsMap = {};
...
const schema = {
  ...
  "if": { "maxItems": 3 },
  "then": { "prefixItems": [ { "type": "string", "default": "foo" } ] },
  "else": { "contains": { "type": "boolean" } },
  "unevaluatedItems": { "type": "array", "prefixItems": [ { "default": "bar" }] }
};
